...
CamZoomOutPosHprs = [
    [
        [
            Vec3(-4, 28.0, 9.1999999999999993),
            Vec3(-0.29999999999999999 + 180.0, -15.699999999999999, -1.6)],
        [
            Vec3(-4, 28.0, 9.1999999999999993),
            Vec3(-0.29999999999999999 + 180.0, -15.699999999999999, -1.6)],
        [
    ...
    [
        [
            Vec3(-4, 20.0, 9.1999999999999993),
            Vec3(-0.29999999999999999 + 180.0, -15.699999999999999, -1.6)],
        [
            Vec3(-4, 20.0, 9.1999999999999993),
            Vec3(-0.29999999999999999 + 180.0, -15.699999999999999, -1.6)],
...
class MakeAPirate(DirectObject, StateData.StateData, FSM.FSM):
    ...
    def assignPirateToGui(self, wantClothingChange):
        ...
        self.clothesGui.assignAvatar(self.pirate.model, True)
